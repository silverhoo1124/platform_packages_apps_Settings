...
import static com.android.internal.util.biantai.NavigationRingConstants.*;
import com.android.internal.util.biantai.NavigationRingHelpers;
...
public class NavRing extends Fragment implements
    ...
    private void onTargetChange(String uri) {
        if (uri.equals(ACTION_APP)) {
            final String label = getResources().getString(R.string.lockscreen_targets_empty);
