...
import com.android.internal.util.biantai.LockscreenTargetUtils;
import com.android.internal.widget.multiwaveview.GlowPadView;
import com.android.internal.widget.multiwaveview.TargetDrawable;
import com.android.settings.R;
import com.android.settings.biantai.IconPicker.OnIconPickListener;
...
public class LockscreenTargets extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mEmptyLabel = mResources.getString(R.string.lockscreen_targets_empty);
    ...
    private void resetAll() {
        new AlertDialog.Builder(mActivity)
                ...
                .setMessage(R.string.lockscreen_targets_reset_message)
                .setPositiveButton(R.string.ok_string, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        // store empty targets
                        saveAll();
                        Toast.makeText(mActivity, R.string.lockscreen_targets_reset,
    ...
    public void onTrigger(View v, final int target) {
        ...
        new AlertDialog.Builder(mActivity)
                .setTitle(R.string.lockscreen_targets_edit_title)
